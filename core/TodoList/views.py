...
class Task(LoginRequiredMixin,ListView):
    template_name='TodoLists/todo_list.html'
...
class Delete_Task(LoginRequiredMixin , DeleteView):
    model = Todo
    success_url = '/'
    template_name = 'TodoLists/todo_del.html'
...
class Update_Task(LoginRequiredMixin , UpdateView):
    ...
    success_url = '/'
    form_class = TaskForm
    template_name='TodoLists/todo_form.html'
    


class Ticked(LoginRequiredMixin, UpdateView):  
    model = Todo  
    template_name = 'TodoLists/todo_form.html'  # نام قالب خود را اینجا قرار دهید  
